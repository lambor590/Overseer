...
const log = (string, style) => {
  const styles = {
    ...
    done: { prefix: chalk.green("[OK]"), logFunction: console.log },
  };
...
/**
 * Delays deletion of a message.
 *
 * @param {import('discord.js').Message} message - The message  to delete.
 * @param {number} timeout - The amount of time to delay.
 */
const msgTimeout = (message, timeout) => setTimeout(() => message.delete().catch(() => null), timeout);
